...
만약 ABC라는 문자가 있다면<br/>
A를 36진법으로 나타내면 10 → <InlineCode>w[10][47] += 1;</InlineCode> (50자리 중에서 뒤에서 3번째)<br/>
B를 36진법으로 나타내면 11 → <InlineCode>w[11][48] += 1;</InlineCode> (50자리 중에서 뒤에서 2번째)<br/>
C를 36진법으로 나타내면 12 → <InlineCode>w[12][49] += 1;</InlineCode> (50자리 중에서 뒤에서 1번째)<br/>
...
Z가 35니까 <InlineCode>35-i</InlineCode>로 계산 !
